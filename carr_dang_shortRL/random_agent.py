...
# Date   : 14 Sept 2020
# Desc.  : create agent that learns how to play TextWorld games
# Note   : Agent and associated code were adapted from TextWorld tutorial at:
# https://github.com/microsoft/TextWorld/blob/d1323ff5248e79d6ee5569031a7dd3c01bd98556/notebooksBuilding%20a%20simple%20agent.ipynb
...
play(RandomAgent(), "./carr_dang_shortRL/compiled_game/games.ulx")
...
agent = NeuralAgent()
play(agent, "./carr_dang_shortRL/compiled_game/games.ulx")
...
starttime = time()
play(agent, "./carr_dang_shortRL/compiled_game/games.ulx", nb_episodes=500, verbose=False)  # Dense rewards game.
